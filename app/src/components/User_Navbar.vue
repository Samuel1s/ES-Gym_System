<template>
    <nav>
        <v-navigation-drawer v-model="drawer" dark app mini-variant mini-variant-width="100" class="light-blue accent-4">
            <v-list>
                <v-list-item>
            ...
            <v-list style="position: absolute; bottom:0" class="ml-3" flat @click="clearState()">
